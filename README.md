...
```bash
bash <(curl -s https://raw.githubusercontent.com/NavitaBurhan/ptrodactyl-installer/main/installer.sh)
```
...
```bash
bash <(curl -s https://raw.githubusercontent.com/NavitaBurhan/ptrodactyl-installer/main/autoinstall.sh)  <fqdn> <ssl> <email> <username> <firstname <lastname> <password> <wings>
```
